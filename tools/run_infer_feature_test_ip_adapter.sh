...
DATASET_ROOT="${DATASET_ROOT:-/root/autodl-tmp/deformity_dataset/Feature_test}"
...
export GEN_OUTPUT_ROOT="${GEN_OUTPUT_ROOT:-${PROJECT_ROOT}/Image_output/generation/ip_adapter_feature_test}"
...
export LORA_WEIGHTS_PATH="${LORA_WEIGHTS_PATH:-}"
...
export STRENGTH="${STRENGTH:-0.60}"
export GUIDANCE_SCALE="${GUIDANCE_SCALE:-6.0}"
